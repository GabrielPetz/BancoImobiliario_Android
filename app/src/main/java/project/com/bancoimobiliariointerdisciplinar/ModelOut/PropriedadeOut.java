...
public class PropriedadeOut {
    ...
    public PropriedadeOut(String prolote, Integer procasa, Integer protipolote, Double provalorcompra, Double provaloraluguel1, Double provaloraluguel2, Double provaloraluguel3, Double provaloraluguel4, Double provaloraluguelhotel) {
